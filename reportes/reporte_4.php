    ...
    <div class="container-fluid">
        <div class="row content-wrapper justify-content-center">
            <div class="col-lg-12" data-form-type="formoid">
                ...
                <nav style="background-color:rgba(9 70 99)"><h1 class="text-white text-center pb-4 pt-4">Reporte 4</h1></nav>
                                ...
                                <div class="col">
                                    <table class="table-striped table-bordered" style="widht:100%">
                                        <thead class="text-center table-danger table-striped">
                                            <h3 class="text-center pb-4 pt-4 font-weight-bold">Observaciones Reporte 4</h3>
                                            <tr>
                                        ...
                                        <tbody class="text-center">
                                                <!----------- Consulta para el reporte 4 ----------->
                                                <?php
                                                    $sqlreporte = "SELECT * FROM reportes WHERE numerorep = 4 ";
                                ...
                                <form action="../php/registrar_compromiso_4.php" method="POST">
                                    ...
                                    <div class="row text-center justify-content-center">
                                        <div class="col-lg-12 col-md col-12 form-group pb-2">
                                            <textarea name="compromiso_4" placeholder="Escribe tu compromiso" class="form-control" required></textarea>
                                        </div>
                                    </div>
...
<section>
    <div class="container">
	<!----------------------------- Mostrando compromiso para el reporte 4 desde la Base de Datos ---------------------->
...
<!---------------------------------- Consulta para el compromiso ---------------------------------------------------->
                    ...
                    <?php
                        $sqlreporte = "SELECT * FROM compromiso_4";
                        $resultadoreporte=mysqli_query($conexion,$sqlreporte);
                        while($mostrar = $resultadoreporte->fetch_array(MYSQLI_BOTH)){
                        ?>
                        <tr>
                            <?php
                                if($_SESSION['idusuario'] === $mostrar['idusuario']){
                            ?>
                            <th style="font-weight: 100;"><?php echo $mostrar['fechacom_4']?></th>
                            <th style="font-weight: 100;"><?php echo $mostrar['compromiso_4']?></th>
                            <?php
                                }
                            ?>
                        </tr>
