    ...
    <div class="container-fluid">
        <div class="row content-wrapper justify-content-center">
            <div class="col-lg-12" data-form-type="formoid">
                ...
                <nav style="background-color:rgba(9 70 99)"><h1 class="text-white text-center pb-4 pt-4">Reporte 1</h1></nav>
                            ...
                            <div class="col">
                                <table class="table-striped table-bordered" style="widht:100%">
                                    <thead class="text-center table-danger table-striped">
                                        <h3 class="text-center pb-4 pt-4 font-weight-bold">Observaciones Reporte 1</h3>
                                        <tr>
                                    ...
                                    <tbody class="text-center" style="font-weight: 100">
                                            <!----------- Consulta para el reporte 1 ----------->
                                            <?php
                                                $sqlreporte = "SELECT * FROM reportes WHERE numerorep = 1";
                                ...
                                <form action="../php/registrar_compromiso_1.php" method="POST">
                                    ...
                                    <div class="row text-center justify-content-center">
                                        <div class="col-lg-12 col-md col-12 form-group pb-2">
                                            <textarea name="compromiso" placeholder="Escribe tu compromiso" class="form-control" required></textarea>
                                        </div>
                                    </div>
...
<section>
    <div class="container">
    <!-- --------------------------- Mostrando compromiso para el reporte 1 desde la Base de Datos -------------------- -->
...
<!---------------------------------- Consulta para el compromiso ---------------------------------------------------->
                ...
                <?php
                    $sqlreporte = "SELECT * FROM compromiso_1";
                    $resultadoreporte=mysqli_query($conexion,$sqlreporte);
                    while($mostrar = $resultadoreporte->fetch_array(MYSQLI_BOTH)){
                    ?>
                    <tr>
                        <?php
                            if($_SESSION['idusuario'] === $mostrar['idusuario']){
                        ?>
                        <th style="font-weight: 100;"><?php echo $mostrar['fechacom']?></th>
                        <th style="font-weight: 100;"><?php echo $mostrar['compromiso']?></th>
                        <?php
                            }
                        ?>
                    </tr>
