...
<!---------------------------------- Consulta para el compromiso ---------------------------------------------------->
                ...
                <?php
                    $sqlreporte = "SELECT U.nombre, R.fecharep, R.observaciones, C.fechacom_6, C.compromiso_6
                    FROM usuarios U 
                        INNER JOIN reportes R
                            ON U.idusuario = R.idusuario
                                INNER JOIN compromiso_6 C 
                    ...
                    <tr>
                        ...
                        <th style="font-weight: 100;"><?php echo $mostrar['fechacom_6']?></th>
                        <th style="font-weight: 100;"><?php echo $mostrar['compromiso_6']?></th>
                        <?php
                            }
                        ?>
                    </tr>
